...
一个 Claude Code 技能——把任何播客转写文件变成**可复用的 AI 判断资产**，让洞见不再听完就忘，而是持续沉淀、复利增长，真正改变你做产品决策的方式。

给它一份转写文件，它产出结构化框架卡、决策清单、面试表达素材、个人成长日志——对于里程碑级别的单集，还能生成一个漂亮的交互式 HTML 课程。

## 谁需要这个？

**产品人、创业者、Builder**——你听了大量 AI/Agent/AI 产品播客，但听完就忘，无法系统化，更无法应用到实际工作中。
